...
const STATE_RACES = {
  ...
  NY: {
    ...
    governor: {
      rating: 'Likely D',
      note: 'Incumbent Gov. Kathy Hochul (D) is seeking re-election to a second full term. Nassau County Executive Bruce Blakeman (R), endorsed by Trump after Elise Stefanik withdrew, is the likely Republican nominee. NY primary is June 23, 2026.',
      candidates: [
    ...
    competitiveHouse: [
      {
        ...
        note: 'Freshman Rep. Laura Gillen (D) unseated Anthony D\'Esposito (R) in 2024 by only 8,600 votes (2.3 points). D\'Esposito voted Yes on all three weapons packages. Gillen endorsed by and went on a trip sponsored by the foreign lobby. Facing a primary challenge from Taylor Darling (D) on June 23. District has a significant Jewish population.',
        incumbent: { name: 'Laura Gillen', party: 'D', termStart: 2025, keyVotes: { hr6126: null, hr8034: null, hr815: null, hr8369: null }, lobbyFunding: null, lobbyEndorsed: true, lobbyTrip: true, notableActions: ['Freshman — no 118th Congress voting record on weapons packages', 'Went on a trip sponsored by the foreign lobby for the government of Israel (August 2025)', 'Publicly supports the government of Israel\'s "right to defend itself"', 'Facing June 23 primary challenge from Taylor Darling'], source: 'Cook Political Report, Ballotpedia, Jewish Insider' },
        challenger: { name: 'TBD', party: 'R', background: 'Republican primary June 23, 2026. D\'Esposito is not running for a rematch. Multiple Republicans filed including Dennis McGrath, Brian Miller, Martin Smithmyer, and Marvin Suber Williams.', foreignPolicyPosition: null, lobbyFunding: null, lobbyEndorsed: false, source: 'Ballotpedia, FOX 5 NY' },
        predecessorVotes: { hr6126: 'Yes', hr8034: 'Yes', hr8369: 'Yes' },
      ...
      },
      {
        ...
        note: 'Mike Lawler (R) is the #26 highest recipient of funding from the foreign lobby for the government of Israel in Congress — $685,000+ career total. Voted Yes on all three weapons packages. Introduced the "Stand With Israel Act." One of only 3 districts nationally held by a Republican that Kamala Harris won in 2024. Democratic primary is June 23 — five candidates are competing.',
        ...
        challenger: { name: 'TBD', party: 'D', background: 'Democratic primary June 23, 2026. Five candidates: Beth Davidson (Rockland County legislator, polled at 23%), Cait Conley (national security veteran, 17%), John Cappello (Air Force vet with experience in the government of Israel), Effie Phillips-Staley (progressive), and others.', foreignPolicyPosition: null, lobbyFunding: null, lobbyEndorsed: false, source: 'Jewish Insider, News 12 Hudson Valley, Ballotpedia' }
      },
      {
        district: 19, label: 'NY-19', area: 'Hudson Valley / Catskills / Ithaca', rating: 'Lean D', redistricted: false,
        note: 'Freshman Rep. Josh Riley (D) narrowly defeated Marc Molinaro (R) in 2024 in a rematch from 2022. Molinaro voted Yes on all three weapons packages. Less competitive than NY-04 and NY-17.',
        ...
        challenger: { name: 'TBD', party: 'R', background: 'Republican candidates TBD. Molinaro is not seeking a rematch.', foreignPolicyPosition: null, lobbyFunding: null, lobbyEndorsed: false, source: 'Ballotpedia' },
        predecessorVotes: { hr6126: 'Yes', hr8034: 'Yes', hr8369: 'Yes' },
